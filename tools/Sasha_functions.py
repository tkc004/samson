...
def read_halo_history_pep(rundir, finalno, singlesnap=1, beginno=100,halonostr='00', multifile='n', hubble=1,comoving=1, maindir='scratch',firever=1): #to output comoving distance comoving = 1
        redlist = []
        idlist = []
        xlist = []
        ylist = []
...
def snapshotzstr(firever=1):
	if firever==1:
		...
		exit()
	spmname='/home/tkc004/samsonprogram/data/snapshot_times.txt'
