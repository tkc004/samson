...
def enclosedmass(runtodo, time, minr, maxr, galcen=0, unitRv=0,needDM=1,needS=1,needG=1):
		Gmlist=[]
		Smlist=[]
		DMmlist=[]
		...
		return {'rlist':rlist,'vollist':vollist,'Gmlist':Gmlist,'Smlist':Smlist,'DMmlist':DMmlist,'halocolor':halocolor}
