...
refflist=[[2.9,1.3,3.1],[1.5,1.1,1.5],[2.0,1.2,2.0],[2.0,0.7,4.0],[1.3,1.3,1.5],[0.5,0.5,2.9]]
refflist=[[2.9,1.4,3.2],[1.4,1.3,1.4],[2.0,1.3,2.0],[1.7,1.3,4.0],[1.3,1.3,1.5],[1.6,1.6,2.5]]
zr=0
...
for ncount in range(len(dirneed)):
	...
	for icount in range(len(tlist[ncount])):
		...
		reffp=refflist[ncount][icount]	
		Seff,DMeff,mvir,mstar=meff(runtodo,time,reffp)
		ms02,DM02,m02,ms02 = meff(runtodo,time,0.2,unitRv=1)
		ms02list.append(ms02)
		Selist.append(Seff)
		DMelist.append(DMeff)
